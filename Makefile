...
install: all
	...
	install -Dm644 completions/clipsim.fish \
		${DESTDIR}${PREFIX}/share/fish/vendor_completions.d/clipsim.fish
	install -Dm644 completions/clipsim.bash \
		${DESTDIR}${PREFIX}/share/bash-completion/completions/clipsim
	install -Dm644 completions/clipsim.zsh  \
		${DESTDIR}${PREFIX}/share/zsh/site-functions/_clipsim
	install -Dm644 LICENSE                  \
		${DESTDIR}${PREFIX}/share/licenses/${pkgname}/LICENSE
uninstall:
