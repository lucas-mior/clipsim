...
install: all
	...
	install -Dm644 completions/bash/clipsim-completion.bash ${DESTDIR}${PREFIX}/share/bash-completion/completions/clipsim
	install -Dm644 completions/zsh/_clipsim ${DESTDIR}${PREFIX}/share/zsh/site-functions/_clipsim
