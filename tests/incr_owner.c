    ...
    while (1) {
        ...
        if (e.type == SelectionRequest) {
            ...
            if (req->target == targets) {
                ...
                XChangeProperty(d, req->requestor, req->property, incr, 32,
                                PropModeReplace, (unsigned char *)&min_size, 1);
                res.xselection.property = req->property;
                ...
                while (1) {
                    ...
                    if (pe.type == PropertyNotify
                        && pe.xproperty.state == PropertyDelete
                        && pe.xproperty.atom == req->property) {
                        break;
                    }
                }
                ...
                if (!is_large) {
                    ...
                    XChangeProperty(d, req->requestor, req->property, utf8, 8,
                                    PropModeReplace, (unsigned char *)chunk1,
                                    6);
                    ...
                    XChangeProperty(d, req->requestor, req->property, utf8, 8,
                                    PropModeReplace, (unsigned char *)chunk2,
                                    9);
                    ...
                    memset64(buf, 'A', size);
                    XChangeProperty(d, req->requestor, req->property, utf8, 8,
                                    PropModeReplace, (unsigned char *)buf,
                                    size);
                    free2(buf, size);
                    while (1) {
                        XNextEvent(d, &pe);
