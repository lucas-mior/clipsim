...
int f2s_buffered_n(float f, char* result) {
  ...
  ieeeMantissa = bits & ((1u << FLOAT_MANTISSA_BITS) - 1);
  ieeeExponent = (bits >> FLOAT_MANTISSA_BITS) & ((1u << FLOAT_EXPONENT_BITS) - 1);
